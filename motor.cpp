...
void set_speed(PID_Vars* pid,
  ...
  serial_motor_controls(motor_tag, 
    ...
    *speed_cmd = *serial_val;// the actual speed command is a funtion of the pwm command not the raw output as written above
...
void set_speed_of_turret(PID_Vars* pid,
    ...
    *serial_val = constrain(*serial_val, -3200, 3200);
    ...
    if (speed_req == 0) {    //Serial.println(speed_act); 
    // Deadband
    *serial_val = 0; 
     //*pwm_val = 0.0;
    }
